// Adapted from https://github.com/Gui-Yom/hlbc/blob/master/src/deser.rs under the MIT license.

package dashlink.api;

import hl.UI8;

// TODO: Make missing types.
...
interface IHlReader {
	...
	function readRefType():RefType;
	function readTypeFun():TypeFun;
	function readTypeObj():TypeObj;
